...
In this tutorial you will be taken through some of the main usage patterns
...
are presented with the option to install it on-the-fly.
#+end_note
...
~DataFrame~ is as simple as ~d"boston"~.
